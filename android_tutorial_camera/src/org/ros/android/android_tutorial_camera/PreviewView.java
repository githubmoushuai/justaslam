...
public class PreviewView extends ViewGroup {
    ...
    public final class BufferingPreviewCallback implements PreviewCallback {
        ...
        public void onPreviewFrame(byte[] data, Camera camera) {
            Preconditions.checkArgument(camera == PreviewView.this.camera);
    ...
    private void init(Context context) {
        ...
        surfaceHolder.addCallback(new PreviewView.SurfaceHolderCallback());
        surfaceHolder.setType(SurfaceHolder.SURFACE_TYPE_PUSH_BUFFERS);
        bufferingPreviewCallback = new PreviewView.BufferingPreviewCallback();
