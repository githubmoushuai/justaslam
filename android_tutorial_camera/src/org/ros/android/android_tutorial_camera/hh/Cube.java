...
import org.ros.android.android_tutorial_camera.R;
import org.ros.android.android_tutorial_camera.hh.util.ShaderHelper;
import org.ros.android.android_tutorial_camera.hh.util.TextResourceReader;
...
//        System.out.println(MatrixState.view_matrix[0] + " " + MatrixState.view_matrix[1] + " " + MatrixState.view_matrix[2] + " " + MatrixState.view_matrix[3]);
//        System.out.println(MatrixState.view_matrix[4] + " " + MatrixState.view_matrix[5] + " " + MatrixState.view_matrix[6] + " " + MatrixState.view_matrix[7]);
//        System.out.println(MatrixState.view_matrix[8] + " " + MatrixState.view_matrix[9] + " " + MatrixState.view_matrix[10] + " " + MatrixState.view_matrix[11]);
//        System.out.println(MatrixState.view_matrix[12] + " " + MatrixState.view_matrix[13] + " " + MatrixState.view_matrix[14] + " " + MatrixState.view_matrix[15]);
//
//
